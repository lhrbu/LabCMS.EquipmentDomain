...
dotnet publish -c Release -r win10-x64 -p:ReadyToRun=true -p:PublishSingleFile=true -p:DeleteExistingFiles=true --no-self-contained -o ..\Publish\LabCMS.FixtureDomain.Server\
cd ..\LabCMS.EquipmentDomain.Server\
dotnet publish -c Release -r win10-x64 -p:ReadyToRun=true -p:PublishSingleFile=true -p:DeleteExistingFiles=true --no-self-contained -o ..\Publish\LabCMS.EquipmentDomain.Server\
cd ..